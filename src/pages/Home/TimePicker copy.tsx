  ...
  const applyRelativeRange = () => {
    ...
    if (relativeTimeSettings.toOption === 'now') {
      ...
      if (relativeTimeSettings.toValue !== 0) {
        end = end.subtract(relativeTimeSettings.toValue, relativeTimeSettings.toUnit as any);
      }
    }
      ...
      <Tabs activeKey={activeTab} onChange={setActiveTab}>
        ...
        <TabPane tab="绝对时间" key="absolute">
          <div className="absolute-time-panel">
            ...
            <Button
              type="primary"
              onClick={() => applyAbsoluteRange([selectedRange.start, selectedRange.end])}
            >
              应用
            </Button>
          </div>
        ...
        <TabPane tab="相对时间" key="relative">
          <div className="relative-time-panel" style={{ maxWidth: '380px' }}>
            <div className="relative-time-section">
              <div className="relative-time-label" style={{ marginBottom: '8px' }}>
                开始时间：
              </div>
            ...
            <Button type="primary" style={{ marginTop: '16px' }} onClick={applyRelativeRange}>
              应用
            </Button>
          </div>
        </TabPane>
