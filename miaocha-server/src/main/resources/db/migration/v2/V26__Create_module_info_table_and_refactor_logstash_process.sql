...
ALTER TABLE logstash_process ADD COLUMN create_user VARCHAR(64) COMMENT '创建人';
ALTER TABLE logstash_process ADD COLUMN update_user VARCHAR(64) COMMENT '修改人';
...
ADD COLUMN create_user VARCHAR(64) NULL COMMENT '创建人' AFTER update_time,
ADD COLUMN update_user VARCHAR(64) NULL COMMENT '修改人' AFTER create_user;
