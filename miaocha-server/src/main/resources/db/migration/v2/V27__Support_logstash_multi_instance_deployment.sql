...
-- 4. 为新字段添加索引以提高查询性能
CREATE INDEX `idx_logstash_machine_id` ON `logstash_task` (`logstash_machine_id`);
...
CREATE INDEX `idx_task_step_logstash_machine_id` ON `logstash_task_machine_step` (`logstash_machine_id`);
