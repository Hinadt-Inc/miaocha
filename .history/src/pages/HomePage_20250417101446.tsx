    ...
    return {
      ...
      toolbox: {
        feature: {
          dataZoom: {
            ...
            icon: {
              zoom: 'path://M0,0 L0.5,0 L0.5,0.5 L0,0.5 z',  // 使用默认图标
              back: 'path://M0,0 L0.5,0 L0.5,0.5 L0,0.5 z'
            }
          },
          restore: {
            title: '重置'
      ...
      dataZoom: [
        ...
        },
        {
          ...
          rangeMode: ['value', 'value']  // 使用数值缩放模式
        }
      ]
    }
  }
    ...
    datazoom: (params: any) => {
      if (params.batch && params.batch.length > 0) {
        ...
        if (startValue !== undefined && endValue !== undefined) {
          const dates = Array(14).fill(null).map((_, i) => `2025-04-${i + 1}`)
          const startDate = dates[startValue]
          const endDate = dates[endValue]
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 16 }}>
          <Space size="middle">
            ...
            <RangePicker 
              ...
              value={timeRange ? [
                timeRange[0] ? new Date(`${timeRange[0]} 00:00:00`) : null,
                timeRange[1] ? new Date(`${timeRange[1]} 23:59:59`) : null
              ] : null}
              onChange={(dates) => {
