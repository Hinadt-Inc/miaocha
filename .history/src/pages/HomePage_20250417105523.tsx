                ...
                <Panel header="可用字段" key="available">
                  {availableFields.map(field => (
                    <div 
                      ...
                      className={`field-selection-item ${selectedFields.includes(field.name) ? 'selected' : ''} ${lastAddedField === field.name ? 'field-added' : ''} ${lastRemovedField === field.name ? 'field-removed' : ''}`}
                    >
                      <Space>
